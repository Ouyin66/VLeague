...
public class Adapter_Ticket extends BaseAdapter {
    ...
    public Adapter_Ticket(ArrayList<Matches> arrayList) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        View rootView = View.inflate(viewGroup.getContext(), R.layout.layout_listview_ticket, null);

        //Anh xa tu layout match
        ImageView imgLogo1 = (ImageView) rootView.findViewById(R.id.imageLogoOne);
        ...
        TextView tvName1 = (TextView) rootView.findViewById(R.id.tvNameOne);
        TextView tvName2 = (TextView) rootView.findViewById(R.id.tvName2);
...
//        imgLogo2.setImageResource(matches.getLogo2());
        ...
        tvName1.setText(matches.getName1());
        tvName2.setText(matches.getName2());
